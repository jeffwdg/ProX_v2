...
public class lastmonthfragment extends ListActivity{
	...
	private void AddReminder() {
		Intent i = new Intent(lastmonthfragment.this, ReminderAdd.class);
		startActivity(i);
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		AlertDialog.Builder builder3 =new AlertDialog.Builder(lastmonthfragment.this);
