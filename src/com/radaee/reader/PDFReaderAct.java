...
public class PDFReaderAct extends Activity implements OnItemClickListener, OnClickListener, PDFReaderListener, PDFThumbListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		//m_doc = new Document();
		//String pdf_path = "data/data/com.example.prox/proxbooks/aloofzehcnas@gmail.com/nyNxO3OJXX.pdf";
		//String password = "";
	...
	private void onGoToPage()
	{
		...
		AlertDialog.Builder builder4 =new AlertDialog.Builder(PDFReaderAct.this);
